    ...
    <div className="bg-background text-text-primary min-h-screen flex flex-col px-6">
      <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full py-12">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white mb-2">Habitly</h1>
        ...
        {/* Card */}
        <div className="bg-surface border border-border rounded-2xl p-8 shadow-2xl mb-8">
          {/* Form */}
          ...
          <button
            type="button"
            className="w-full flex items-center justify-center gap-3 bg-transparent border border-border-light hover:bg-white/5 text-text-primary font-semibold py-3.5 rounded-xl transition-all cursor-pointer"
          >
